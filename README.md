# Discord.py-Bot
Discord бот на Python для начинающих.
...
2. После установки Python скачиваем необходимые библиотеки, которые находятся в `файле main.py`. Пример: `pip install название библиотеки`.
...
4. Вводим нужные данные в файле `config.py`.

5. Для запуска бота открываем файл `start.bat`.
